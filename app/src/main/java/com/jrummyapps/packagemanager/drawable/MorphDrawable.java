...
package com.jrummyapps.packagemanager.drawable;
...
import com.jrummyapps.packagemanager.utils.AnimUtils;
...
public class MorphDrawable extends Drawable {
  ...
  public static final Property<MorphDrawable, Integer> COLOR = new AnimUtils.IntProperty<MorphDrawable>("color") {
    ...
    @Override public void setValue(MorphDrawable morphDrawable, int value) {
      morphDrawable.setColor(value);
    }

    @Override public Integer get(MorphDrawable morphDrawable) {
